...
git clone https://github.com/me02mo/Memo.Al_iraqi.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf superflux-bot && rm -rf .telegram-cli && git clone https://github.com/me02mo/Memo.Al_iraqi.git && cd Memo.Al_iraqi && ./launch.sh install && ./launch.sh
~~~~~
